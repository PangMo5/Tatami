...
<a id="workspaces"></a>
### 작업 공간
[![작업 사이를 오가기](web/media/ko/workspaces.jpg)](https://pangmo5.dev/Tatami/ko/#demo-workspaces)
...
- **[자동 열기 데모](https://pangmo5.dev/Tatami/ko/#demo-autoopen):** 작업 공간에 들어가면 배정한 앱이 열려요. 창을 닫아도 다시 들어가면 열어줘요.
...
### 창 타일링(BSP)
[![새 창이 제자리를 찾도록 하기](web/media/ko/tiling.jpg)](https://pangmo5.dev/Tatami/ko/#demo-tiling)


- **BSP 자동 배치:** 가장 얕게 나뉜 영역에 새 창을 넣어요.
- **키보드 조작:** vim 방식의 `h`, `j`, `k`, `l` 키로 방향에 따라 포커스·위치·크기를 바꿔요.
...
[프로필과 두 화면 영상 모음 보기](https://pangmo5.dev/Tatami/ko/#profiles).
...
### 빌려오기: 두 작업 공간 함께 쓰기
[![대화를 옆으로 가져오기](web/media/ko/borrow.jpg)](https://pangmo5.dev/Tatami/ko/#demo-borrow)
...
[여러 작업 공간 위에서 같은 상태 창 보기](https://pangmo5.dev/Tatami/ko/#demo-shared).
...
[키보드와 포인터에 따른 포커스 이동 보기](https://pangmo5.dev/Tatami/ko/#demo-focus).
...
[실제 CLI·훅·설정 바로 적용 보기](https://pangmo5.dev/Tatami/ko/#automation).
...
[단축키 연습과 제안 검토 보기](https://pangmo5.dev/Tatami/ko/#guided-setup).
...
모든 항목과 기본값, 단축키 문법은 [docs/CONFIGURATION.md](docs/ko/CONFIGURATION.md)에서 확인해요.

회의 조작 창이나 작업 공간 전환 중 화면 속 화면처럼 앱마다 다른 동작은 [문제 해결](docs/ko/TROUBLESHOOTING.md)에서 확인해요.
...
[전체 CLI 안내](docs/ko/CLI.md)를 읽거나 [pangmo5.dev/Tatami](https://pangmo5.dev/Tatami/ko/cli.html)에서 웹으로 확인할 수 있어요.
...
Tatami는 Wojciech Kulik의 [FlashSpace]에서 가상 작업 공간 전환 개념을, koekeishiya의 [yabai]에서 창 타일링 방식을 참고했어요. 출처는 [NOTICE.md](NOTICE.ko.md), 의존성 라이선스는 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)에서 확인할 수 있어요.
