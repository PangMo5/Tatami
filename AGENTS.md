...
- Write durable rules. Put version-specific findings, measurements, and temporary work status in the relevant issue or report instead of `AGENTS.md`.
...
- Fix evidenced bottlenecks and broken state transitions directly. Do not hide symptoms behind arbitrary delays, retries, or silent fallbacks.
